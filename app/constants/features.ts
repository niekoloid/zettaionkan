...
export const FEATURE_GATES: Record<FeatureKey, FeatureConfig> = {
  ...
  'home_chord_dofara':      { tier: 'entry', enabled: true },
  'home_chord_shireso':     { tier: 'entry', enabled: true },
  'home_chord_radofa':      { tier: 'entry', enabled: true },
  'home_chord_resoshi':     { tier: 'entry', enabled: true },
  'home_chord_misodo':      { tier: 'entry', enabled: true },
  'home_chord_farado':      { tier: 'entry', enabled: true },
  'home_chord_soshire':     { tier: 'entry', enabled: true },
  'home_chord_sodomi':      { tier: 'entry', enabled: true },

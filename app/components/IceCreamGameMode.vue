...
const getFlavorName = (colorName: string) => {
  return (FLAVOR_MAP as Record<string, string>)[colorName] || colorName
}

const getFlavorIcon = (colorName: string) => {
  return (FLAVOR_ICON_MAP as Record<string, string>)[colorName] || ''
}

const getFlavorImage = (colorName: string) => {
  return FLAVOR_IMAGE_MAP[colorName] || undefined
}

                ...
                <div class="flex items-center space-x-1">
                  ...
                  <div class="relative w-16 h-16 shrink-0 group">
                    ...
                    <input 
                      ...
                      @input="e => updateDraft(chord.id, { color: e.target.value })"
                  ...
                  <div class="flex-grow min-w-0">
                    ...
                    <div class="relative">
                      <select 
                        ...
                        @change="e => updateDraft(chord.id, { colorName: e.target.value })"

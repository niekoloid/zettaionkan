    ...
    <main class="flex-grow px-6 pb-20 overflow-y-auto">
      <div class="space-y-12">
        ...
        <div class="pt-4 text-center pb-20">
          <router-link to="/chordquizz" class="block w-full bg-gray-900 text-white px-10 py-5 rounded-3xl font-black text-sm shadow-xl hover:bg-black active:scale-[0.98] transition-all">
            無料トレーニングを始める
          </router-link>
        </div>
      </div>

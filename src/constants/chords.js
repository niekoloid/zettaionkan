export const ChordDefinitions = {
  ...
  RESOSHI: { id: 'resoshi', name: 'レソシ', nameIt: 'レソシ', symbol: 'G/D', colorName: '緑', color: '#16a34a', notes: ['D4', 'G4', 'B4'], abc: '[DGB]' },
  MISODO: { id: 'misodo', name: 'ミソド', nameIt: 'ミソド', symbol: 'C/E', colorName: 'オレンジ', color: '#F97316', notes: ['E4', 'G4', 'C5'], abc: '[EGc]' },
  FARADO: { id: 'farado', name: 'ファラド', nameIt: 'ファラド', symbol: 'F', colorName: '紫', color: '#9333ea', notes: ['F4', 'A4', 'C5'], abc: '[FAc]' },
  SOSHIRE: { id: 'soshire', name: 'ソシレ', nameIt: 'ソシレ', symbol: 'G', colorName: 'ピンク', color: '#fbcfe8', notes: ['G4', 'B4', 'D5'], abc: '[GBd]' },
  SODOMI: { id: 'sodomi', name: 'ソドミ', nameIt: 'ソドミ', symbol: 'C/G', colorName: '茶色', color: '#713F12', notes: ['G4', 'C5', 'E5'], abc: '[Gce]' },

  // --- 黒鍵の和音：基本形 ---
  LA_CIS_MI: { id: 'lacismi', name: 'ラ<u>チス</u>ミ', nameIt: 'ラド♯ミ', symbol: 'A', colorName: '黄緑', color: '#84cc16', notes: ['A3', 'C#4', 'E4'], abc: '[A,^CE]' },
  RE_FIS_LA: { id: 'refisla', name: 'レ<u>フィス</u>ラ', nameIt: 'レファ♯ラ', symbol: 'D', colorName: 'ベージュ', color: '#F5DEB3', notes: ['D4', 'F#4', 'A4'], abc: '[D^FA]' },
  MI_GIS_SI: { id: 'migissi', name: 'ミ<u>ギス</u>シ', nameIt: 'ミソ♯シ', symbol: 'E', colorName: '薄紫', color: '#c4b5fd', notes: ['E4', 'G#4', 'B4'], abc: '[E^GB]' },
  BE_RE_FA: { id: 'berefa', name: '<u>ベー</u>レファ', nameIt: 'シ♭レファ', symbol: 'B♭', colorName: 'グレー', color: '#6B7280', notes: ['Bb3', 'D4', 'F4'], abc: '[_B,DF]' },

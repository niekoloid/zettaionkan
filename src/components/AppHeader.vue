...
<template>
  <header 
    class="pt-10 pb-6 px-4 flex items-center justify-between shrink-0 relative z-20"
  ...
  >
    ...
    <div class="w-10 flex items-center">
      <router-link 
        v-if="showBack" 
        to="/" 
        class="p-2 hover:bg-black/5 rounded-full transition-colors group"
      >
    ...
    <router-link 
      ...
      class="p-2 hover:bg-black/5 rounded-full transition-colors group flex items-center justify-center"
    >

...
const currentCat = computed(() => {
  ...
  if (props.correctHistory.length > 0) {
    ...
    // If last is the current question but not revealed yet?
    // correctHistory only contains revealed ones in AutoPlay.vue
...
const getCatName = (colorName) => {
  return CAT_MAP[colorName] || 'CAT'
}

      ...
      <main class="flex-grow px-6 py-8">
        ...
        <section class="space-y-6">
            ...
            >
              ...
              <div v-if="expandedSessionId === session.id" class="border-t border-gray-100 bg-gray-50/50 p-4">
                  ...
                  <div v-else class="text-center py-4">
                    ...
                    <router-link to="/subscription" class="inline-block text-[10px] font-bold text-amber-500 bg-amber-50 px-3 py-1.5 rounded-full">
                        プランを確認する
                    </router-link>
                  </div>
              </div>
          ...
          <div v-else class="text-center py-10 bg-gray-50 rounded-2xl border border-dashed border-gray-200">
            ...
            <router-link to="/chordquizz" class="inline-block mt-4 text-xs font-bold text-indigo-500 hover:text-indigo-600">
              トレーニングを開始する
            </router-link>
          </div>
        </section>

...
def main():
    ...
    title = "【水色】3秒後に答えが出る絶対音感トレーニング｜ 5時間連続再生 - Steinway Model B / 44.1kHz 16bit 高精度収録"
    video_path = "videos/outputs_5h_delayed/Lv14_5h_delayed_reveal.mp4"
    thumb_path = "videos/outputs/thumbnails_5h/Lv14_5h_thumbnail.jpg" # Reuse same thumb for now

    print(f"Uploading Lv14 Delayed ({video_path})...")
    upload_video(
    ...
    print("Lv14 Delayed uploaded successfully!")
